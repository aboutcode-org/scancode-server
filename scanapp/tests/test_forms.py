...
# The scancode-server software is licensed under the Apache
# License version 2.0.
# Data generated with scancode-server require an acknowledgment.
#
# You may not use this software except in compliance with the License.
# You may obtain a copy of the License at: http://apache.org/licenses/
# LICENSE-2.0
...
class UrlScanFormTestCase(TestCase):
    def test_correct_url_scan_form(self):
        ...
        self.assertEqual('https://github.com',
                         correct_url_scan_form.data['url'])
